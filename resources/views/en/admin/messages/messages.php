              ...
              <input type="text" class="form-control" id="navbar-search-input" placeholder="Search Sales Invoice">
                        ...
                        <li class="dropdown messages-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="label bg-maroon">1</span>
                            </a>
        ...
        <div class="content-wrapper " style="min-height: 788px;">
            ...
            <section class="content-header">
                <h1 class="dashboard-page-title">
                    <i class="fa fa-check-circle"></i> Products
                </h1>
            </section>
            <!-- Content Header (Page header) -->
                                            ...
                                            <tbody>
                                              @foreach ($products as $product)
                                                ...
                                                <tr role="row" class="even">
                                                    <td class="sorting_1">{{$product->product_number}}</td>
                                                    <td class="sorting_1"><img src="{{asset('uploads/categories/'. $product->image)}}" width=40 height=40 alt="logo"></td>
                                                    <td>
                                                      {{$product->name}} <br>
                                                    </td>
                                                    <td>{!! html_entity_decode(e($product->disc)) !!}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class='badge label-{{$product->status == 1 ? "success" : "danger"}}'>{{$product->status == 1 ? "active" : "disabled"}}</span>
                                                    </td>
                                                    <td>
                                                        {{$product->processes === 'accepted' ? 'accepted' : 
                                                        ($product->processes === 'disabled' ? 'disabled' :
                                                        ($product->processes === 'processed' ? 'processed' : 
                                                        ($product->processes === 'Cancelled' ? 'Cancelled' : 'none'))) }}          
                                                    </td>
                                                    <td>
                                                        {{$product->purpose}}
                                                    </td>
