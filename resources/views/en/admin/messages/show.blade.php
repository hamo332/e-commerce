...
<head>
    ...
    <title>Messages | {{$message->title}}</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper " style="min-height: 758px;">
            ...
            <i class="fa fa-eye"></i> Show Messages 
                </h1>
            </section>
            <!-- Content Header (Page header) -->
            ...
            <div class="box">
                ...
                <form id="myForm" action="" method="POST" class="categoryForm" enctype="multipart/form-data" novalidate="novalidate">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <h4 style="margin:0">{{$data['user_create']}}</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="first_name" style="color:#337ab7"><b>Email Address</b></label>
                                            <h4 style="margin:0">hassanali23245@gmail.com </h4>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="first_name" style="color:#337ab7"><b>Phone</b></label>
                                            <h4 style="margin:0">01033653547 </h4>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="first_name" style="color:#337ab7"><b>Subject</b></label>
                                            <h4 style="margin:0">{{$message->title}}</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="first_name" style="color:#337ab7"><b>Message</b></label>
                                            <h4 style="margin:0">{{$message->body}}</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <h4 style="margin:0">
                                                ...
                                                <p>{{$message->created_at->format('h-i-s a')}}</p>
                                            </h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <h4 style="margin:0">
                                                <p>{{$message->updated_at->format('Y-m-d a')}}</p>
                                                <p>{{$message->updated_at->format('h-i-s a')}}</p>
                                            </h4>
                                        </div>
                                    </div>
