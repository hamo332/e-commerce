              ...
              <input type="text" class="form-control" id="navbar-search-input" placeholder="Search Sales Invoice">
                        ...
                        <li class="dropdown messages-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="label bg-maroon">{{Auth()->user()->unreadNotifications()->where('type', 'App\Notifications\admin\MessageNotify')->count()}}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header">You have <span style="font-size:16px"
                                    class="text-maroon"><b>{{Auth()->user()->unreadNotifications()->where('type', 'App\Notifications\admin\MessageNotify')->count()}}</b></span> messages</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                        ...
                        <li class="dropdown messages-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">You have <span style="font-size:16px"
                                        class="text-maroon"><b>{{Auth()->user()->unreadNotifications()->count()}}</b></span> bookings</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form id="myForm" action="{{route('products.store')}}" method="POST"
