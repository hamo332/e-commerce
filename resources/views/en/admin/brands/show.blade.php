   ...
   *,body,div,p,span,label,h1,h2,h3,h4,h5,h6
   {
    ...
    <style>
       *,body,div,p,span,label,h1,h2,h3,h4,h5,h6,a
        {
            font-family: 'Poppins';
            font-weight: 500;
        }
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">You have <span style="font-size:16px" class="text-maroon"><b>0</b></span> comments</li>
              <li>
                ...
                <ul class="menu">
                    ...
                    <a href="#">
                      <div class="pull-left">
                        <img src="../../../uploads/avatars/admins/default.png" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Not found !
                      </h4>
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">You have <span style="font-size:16px" class="text-maroon"><b>0</b></span> messages</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                    ...
                    <a href="#">
                      <div class="pull-left">
                        <img src="../../../uploads/avatars/users/default.png" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Not found !
                      </h4>
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">You have <span style="font-size:16px" class="text-maroon"><b>0</b></span> bookings</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                    ...
                    <a href="#">
                      <div class="pull-left">
                        <img src="../../../uploads/cars/default.png" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Not found !
                      </h4>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../../../uploads/avatars/admins/NdH2M6Ite5mdZiezbY82MplXuSvKX9Z2BD2L9XPF.png" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="../../../uploads/avatars/admins/NdH2M6Ite5mdZiezbY82MplXuSvKX9Z2BD2L9XPF.png" class="img-circle" alt="User Image">
                <p>
              ...
              <li class="user-footer">
                <div class="row">
                  <div class="col-md-12">
                    <div class="">
                      <a href="../../../en/admin/profile" style="margin-bottom:10px" class="btn btn-default btn-block "> <i class="fa fa-user fa-fw"></i> Profile</a>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="">
                      <a target="_blank" href="" style="margin-bottom:10px" class="btn btn-default btn-block "> <i class="fa fa-eye fa-fw"></i> Visit Website</a>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <div class="user-panel">
        <div class="pull-left">
          <img src="../../../uploads/avatars/admins/NdH2M6Ite5mdZiezbY82MplXuSvKX9Z2BD2L9XPF.png" style="width:40px;height:40px;border-radius:50%" class="" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="">
            <a href="../../../en/admin"><i class="fa fa-dashboard text-aqua"></i> <span> Dashboard</span></a>
        </li>
  ...
  <div class="content-wrapper " style="min-height: 698px;">
    ...
    <section class="content-header">
        <h1 class="dashboard-page-title">
            <i class="fa fa-eye"></i> Show Brand
        </h1>
    </section>
    <!-- Content Header (Page header) -->
...
<div class="box">
    ...
    <div class="box-header with-border">
        ...
        <!-- Start Button  -->
            ...
            <a class='btn btn-block btn-{{$brand->status == 1 ? "danger" : "success"}}' href="{{$brand->status == 1 ? route('brand.disabled', $brand->id) : route('brand.active', $brand->id)}}">
                <i class="{{$brand->status == 1 ? "fa fa-fw fa-close" : "fa fa-check fa-fw fa-lg"}}"></i> {{$brand->status == 1 ? "Disable" : "Active"}}</a>
        </div>
        
        <div class="button-page-header" style="margin-top:5px">
            <a class="btn btn-block btn-info" href="{{route('brand.edit', $brand->id)}}">
                <i class="fa fa-pencil fa-fw fa-lg"></i> Edit</a>
        </div>

        <div class="button-page-header" style="margin-top:5px">
            <a class="btn btn-block btn-warning" href="{{route('brands')}}">
    ...
    <div class="box-body">
      ...
      @endif
        <form id="myForm" action="" method="POST" class="brandForm" enctype="multipart/form-data" novalidate="novalidate">
            <input type="hidden" name="_token" value="p58rB5Ebn1EMpmFRxuqaE5fBfScvhPymbwHSZ96G">

            <input type="hidden" name="brand_id" value="14">

            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <!-- <label for="exampleInpu style="color:#337ab7"tFile"><b>Image</b></label> -->
                        <div class="imagePreview">
                            <img style="width:100%;height:270px;margin-top:5px" class="image-preview img-thumbnail" src="{{asset('uploads/avatars/'. $brand->image)}}" alt="">
                        </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="first_name" style="color:#337ab7"><b>Name</b></label>
                                <h4 style="margin:0">{{$brand->name}}</h4>
                            </div>
                        </div>
                        {{-- <div class="col-md-5">
                            <div class="form-group">
                                <label for="first_name" style="color:#337ab7"><b>English Name</b></label>
                                <h4 style="margin:0">asdasdasd </h4>
                            </div>
                        </div> --}}
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="first_name" style="color:#337ab7"><b>Status</b></label>
                                <h4 style="margin:0">
                                  <span class='badge label-{{$brand->status == 1 ? "success" : "danger"}}'>{{$brand->status == 1 ? "active" : "disabled"}}</span>
                                </h4>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>CreatedBy</b></label>
                                    <h4 style="margin:0">
                                        @if ($brand->userCreatedBrand->role == 2)
                                            Super admin
                                        @elseif ($brand->role == 1)
                                            admin
                                        @else
                                    ...
                                    <h4 style="margin:0">{{$brand->userCreatedBrand->email}} </h4>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>UpdateBy</b></label>
                                    <h4 style="margin:0">
                                      @if ($brand->userUpdatedBrand->role == 2)
                                      Super admin
                                      @elseif ($brand->role == 1)
                                          admin
                                      @else
                                    ...
                                    <h4 style="margin:0">{{$brand->userUpdatedBrand->email}} </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>CreatedAt</b></label>
                                    <h4 style="margin:0">
                                        <p>{{$brand->created_at->format('Y-m-d')}} </p>
                                        <p>{{$brand->created_at->format('H:i:s a')}}</p>
                                    </h4>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>UpdatedAt</b></label>
                                    <h4 style="margin:0">
                                        <p>{{$brand->updated_at->format('Y-m-d')}}</p>
                                        <p>{{$brand->updated_at->format('H:i:s a')}}</p>
                                    </h4>
                                </div>
                            </div>
                            <!-- End Row  -->
  ...
  <footer class="main-footer">
    ...
    <strong> <i class="fa fa-heart fa-fw fa-lg" style="color:red"></i> &nbsp;&nbsp; Copyright &copy; <span style="color:#56a7ed">2023</span> All Rights Reserved</strong>
  </footer>
...
$(document).ready(function(){
    ...
    // Summer note ..
    $('#desc_ar').summernote({ height : 150 });
    $('#desc_en').summernote({ height : 150 });
