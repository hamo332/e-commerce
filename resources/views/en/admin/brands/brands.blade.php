                  ...
                  <div class="col-md-12">
                    <div class="">
                      <form action="../../../en/admin/logout" method="POST">
                          <input type="hidden" name="_token" value="ZAJtw9eJVRmUyfQs0gTEYNxmdrcgAv3fbbrIdUre">                          <button type="submit" style="cursor:pointer" class="btn btn-default btn-block confirm_logout"><i class="fa fa-power-off fa-fw"></i> Logout</button>
                      </form>
                    </div>
                  </div>
                </div>
  ...
  <div class="content-wrapper " style="min-height: 536px;">
    ...
    <section class="content-header">
      <h1 class="dashboard-page-title">
           <i class="fa fa-bookmark"></i> Brands</h1>
    </section>
    <!-- Main content -->
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            ...
            <div class="button-page-header">
                <a class="btn btn-block btn-primary" href="{{route('brands.create')}}">
                <i class="fa fa-plus fa-fw fa-lg"></i> Create New</a>
            </div>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0"
                                                ...
                                                style="width: 20px;">#Image</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1"
                                                aria-label="Customer: activate to sort column ascending"
                                                style="width: 119px;"><b>Name</b></th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1"
                                                aria-label="Car: activate to sort column ascending"
                                                style="width: 105px;"><b>Description</b></th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1"
                                                aria-label="Date: activate to sort column ascending"
                                                style="width: 121px;"><b>Bulding</b></th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1"
                                                aria-label="Time: activate to sort column ascending"
                                                style="width: 121px;"><b>Action</b></th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1"
                                    ...
                                    <tbody>
                                      @foreach ($brands as $brand)
                                        <tr role="row" class="even">
                                            <td class="sorting_1"><img src="{{asset('uploads/avatars/'. $brand->image)}}" width=40 height=40 alt="logo"></td>
                                            <td>
                                                {{$brand->name}} <br>
                                            </td>
                                            <td>{!! html_entity_decode(e($brand->desc)) !!}</td>
                                            <td>
                                                <div><b>Created at:</b>{{$brand->created_at}} </div>
                                                <div><b>Updated by:</b>{{$brand->userUpdatedBrand->name}} </div>
                                            </td>
                                            <td>
                                                <div><b>Created by:</b>{{$brand->userCreatedBrand->name}} </div>
                                                <div><b>Updated at:</b>{{$brand->updated_at->format('Y-m-d')}} </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                              <div class="btn-group manage-button" title="View Account">
                                                  ...
                                                  <ul role="menu" class="dropdown-menu dropdown-light pull-right">
                                                    <li>
                                                        <a title="Disable Record" href="{{$brand->status == 1 ? route('brand.disabled', $brand->id) : route('brand.active', $brand->id)}}">
                                                            <i class="{{$brand->status == 1 ? "fa fa-fw fa-close" : "fa fa-check fa-fw fa-lg"}}"></i> {{$brand->status == 1 ? "Disable" : "Active"}}
                                                        </a>
                                                    </li>
                                                      
                                                      <li>
                                                          <a title="Show Record" href="{{route('brand.show', $brand->id)}}">
                                                              <i class="fa fa-fw fa-eye"></i> Show
                                                          </a>
                                                      </li>
              
                                                      <li>
                                                          <a title="Edit Record" href="{{route('brand.edit', $brand->id)}}">
                                                      ...
                                                      <li>
                                                          <form action="{{route('brand.destroy', $brand->id)}}" method="POST" style="display:inline">
                                                            @csrf
                                                              <button title="Edit Record" type="submit" class="delete" style="cursor:pointer">
