...
<div class="wrapper">
  ...
  <div class="content-wrapper ">
    ...
    <i class="fa fa-tags"></i> Edit Brands 
        </h1>
    </section>
    <!-- Content Header (Page header) -->
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{route('brand.update', $brand->id)}}" method="POST" class="userForm" enctype="multipart/form-data">
              @if(session('success'))
                ...
                <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" id="name_en" class="form-control" value="{{$brand->name}}">
                              @error('name_en')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputFile"><b>Logo</b></label>
                            <input type="file" name="image" id="exampleInputFile" style="padding: 10px;height:45px" class="form-control image ">
                              ...
                              @enderror
                                ...
                                <img style="width:450px;margin-top:5px" class="image-preview img-thumbnail" src="{{asset('uploads/avatars/'. $brand->image)}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="desc_en"><b>Description</b></label>
                              @error('desc_en')
                                  <span class="text-danger text-bold text-center">{{ $message }}</span>
                              @enderror
                                <textarea name="desc_en" id="desc_en" rows="5" class="form-control">{{$brand->desc}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
