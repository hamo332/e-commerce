                    ...
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-header with-border" style="padding:15px">
                                <h3 class="box-title"> Product Information | {{$product->name}}</h3>
                                ...
                                <form id="myForm" action="" method="POST" class="bookingForm"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Product Number</b></h5>
                                                <h5 style="font-size:16px">{{$product->product_number}}</h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Created at</b></h5>
                                                <h5 style="font-size:16px">{{$product->created_at}}</h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Last Update</b></h5>
                                                <h5 style="font-size:16px">{{$product->updated_at}}</h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Purpose</b></h5>
                                                <h5 style="font-size:16px">{{$product->purpose}}</h5>
                                            </div>

                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Price</b></h5>
                                                <h5 style="font-size:16px">
                                                    {{$product->price}}E <b style="font-size:20px"></b>
                                                </h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Discount</b></h5>
                                                <h5 style="font-size:16px">{{$product->discount}}%</h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Total Price</b></h5>
                                                <h5 style="font-size:16px">
                                                    {{ $product->price - (($product->discount / 100) * $product->price)}}E
                                                </h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                ...
                                                <h5>
                                                    <span
                                                        class='badge label-{{$product->status == 1 ? "success" : "danger"}}'>{{$product->status == 1 ? "active" : "disabled"}}</span>
                                                </h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                ...
                                <form id="myForm" action="" method="POST" class="bookingForm"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div style="display:flex;justify-content:space-between">
                                                <div class="text-center" style="margin:auto">
                                                    <img src="{{asset('uploads/profile/'. $product->userCreateProduct->image)}}"
                                                        style="width:200px" class="img-thumbnail" alt="">
                                                </div>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Name</b></h5>
                                                <h5 style="font-size:16px">{{$product->userCreateProduct->name}} </h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Email Address</b></h5>
                                                <h5 style="font-size:16px">{{$product->userCreateProduct->email}}</h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Phone</b></h5>
                                                <h5 style="font-size:16px">{{$product->userCreateProduct->phone}}</h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                              <h5 style="font-size:16px"><b>Gender</b></h5>
                                              <h5 style="font-size:16px">
                                                {{$product->userCreateProduct->gender == 'male' ? 'male' : 'female'}}
                                              </h5>
                                          </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Address</b></h5>
                                                <h5 style="font-size:16px">{{$product->userCreateProduct->address}} </h5>
                                            </div>
                                            <div style="display:flex;justify-content:space-between">
                                                <h5 style="font-size:16px"><b>Post Code</b></h5>
                                                <h5 style="font-size:16px">{{$product->userCreateProduct->post_code}}</h5>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-body">
                                ...
                                <form id="myForm" action="" method="POST" class="carForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h4><b class="text-primary">Created by:</b>
                                              {{$product->userCreateProduct->email}}
                                            </h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h4><b class="text-primary">Updated by:</b>
                                                      {{$product->userUpdatedProduct->email}}
                                                    </h4>
                                                </div>
                                                <div class="col-md-6">
                                    ...
                                    <div class="car-images">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                              {!! html_entity_decode(e($product->disc)) !!}
                                            </div>
                                        </div>
                                    </div>
