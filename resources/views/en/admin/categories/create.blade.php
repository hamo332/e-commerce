...
<div class="wrapper">
  ...
  <div class="content-wrapper ">
    ...
    <i class="fa fa-tags"></i> Create Categories 
        </h1>
    </section>
    <!-- Content Header (Page header) -->
    ...
    <div class="box">
        ...
        <div class="box-header with-border">
            ...
            <div class="button-page-header" style="margin-top:5px">
                <a class="btn btn-block btn-warning" href="../../../en/admin/categories">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="../../../en/admin/categories/store" method="POST" class="userForm" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="ZAJtw9eJVRmUyfQs0gTEYNxmdrcgAv3fbbrIdUre">

                <!-- Start Row  -->
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name_ar"><b>Arabic Name</b></label>
                            <input type="text" name="name_ar" id="name_ar" class="form-control " value="">
                                                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name_en"><b>English Name</b></label>
                            <input type="text" name="name_en" id="name_en" class="form-control " value="">
                                                    </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputFile"><b>Image</b></label>
                            <input type="file" name="image" id="exampleInputFile" style="padding: 10px;height:45px" class="form-control image ">
                                                        <div class="imagePreview text-center">
                                <img style="width:450px;margin-top:5px" class="image-preview img-thumbnail" src="../../../uploads/categories/default.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="desc_ar"><b>Description Arabic</b></label>
                                <textarea name="desc_ar" id="desc_ar" rows="5" class="form-control "></textarea>
                                                    </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="desc_en"><b>Description English</b></label>
                                <textarea name="desc_en" id="desc_en" rows="5" class="form-control "></textarea>
                                                    </div>
                    </div>
                    <div class="col-md-12">
