...
<head>
    ...
    <title>Comments | {{$comment->id}}</title>
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="button-page-header" style="margin-top:5px">
                            <a class="btn btn-block btn-success"
                                href="http://carsrental.great-site.net/en/admin/comments/activation/17">
                                <i class="fa fa-check fa-fw fa-lg"></i> Activation</a>
                        </div>

                        <div class="button-page-header" style="margin-top:5px">
                            <a class="btn btn-block btn-warning"
                                href="http://carsrental.great-site.net/en/admin/comments/pending">
                    ...
                    <div class="box-body">
                        ...
                        <form id="myForm" action="" method="POST" class="categoryForm" enctype="multipart/form-data"
                            novalidate="novalidate">
                            <input type="hidden" name="_token" value="g0C6EJf6liZK8X54GDBLfj7v6ZOzjbeP9Je4VugW">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label for="first_name" style="color:#337ab7"><b>Comment</b></label>
                                                <h4 style="margin:0"> {{$comment->comment}} </h4>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="first_name" style="color:#337ab7"><b>Ratings / 5</b></label>
                                                <h4 style="margin:0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="first_name" style="color:#337ab7"><b>Product</b></label>
                                                <h4 style="margin:0">{{$product->name}} </h4>
                                                <h4 style="margin:0">
                                                    <img src="{{asset('uploads/categories/'. $product->image)}}"
                                                        class="img-thumbnail" style="width:200px" alt="">
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="first_name" style="color:#337ab7"><b>Customer</b></label>
                                                <h4 style="margin:0">{{$data['user_createName']}}</h4>
                                                <h4 style="margin:0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <h4 style="margin:0">
                                                    ...
                                                    <p>{{$comment->created_at->format('h-i-s a')}}</p>
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <h4 style="margin:0">
                                                    <p>{{$comment->updated_at->format('Y-m-d')}}</p>
                                                    <p>{{$comment->updated_at->format('h-i-s a')}}</p>
                                                </h4>
                                            </div>
                                        </div>
                                        <!-- End Row  -->
