...
<!-- FORM CSS CODE -->
  ...
  <title>Edit Brand | {{$section->name}}</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper ">
    ...
    <div class="box">
        ...
        <div class="box-body">
          <form id="myForm" action="{{route('sections.update', 1)}}" method="POST" class="userForm">
            @method('PUT')
            @if(session('success'))
                ...
                <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" id="name_en" class="form-control" value="{{$section->name}}">
                              @error('name_en')
                        ...
                        <div class="form-group">
                            <label for="desc_en"><b>Description</b></label>
                              @error('desc_en')
                                  <span class="text-danger text-bold text-center">{{ $message }}</span>
                              @enderror
                                <textarea name="desc_en" id="desc_en" rows="5" class="form-control ">{{$section->desc}} </textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
