...
<div class="wrapper">
  ...
  <div class="content-wrapper ">
    ...
    <i class="fa fa-tags"></i> Create Section
        </h1>
    </section>
    <!-- Content Header (Page header) -->
    ...
    <div class="box">
        ...
        <div class="box-header with-border">
            ...
            <div class="button-page-header" style="margin-top:5px">
                <a class="btn btn-block btn-warning" href="{{route('sections.index')}}">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{route('sections.store')}}" method="POST" class="userForm" enctype="multipart/form-data">
              @if(session('success'))
                        ...
                        <div class="form-group">
                            <label for="desc_en"><b>Description</b></label>
                              @error('desc_en')
                                  <span class="text-danger text-bold text-center">{{ $message }}</span>
                              @enderror
                                <textarea name="desc_en" id="desc_en" rows="5" class="form-control ">{{old('desc_en')}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
