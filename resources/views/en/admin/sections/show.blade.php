        ...
        <div class="content-wrapper " style="min-height: 698px;">
            ...
            <section class="content-header">
                <h1 class="dashboard-page-title">
                    <i class="fa fa-eye"></i> Show Section
                </h1>
            </section>
            <!-- Content Header (Page header) -->
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="button-page-header" style="margin-top:5px">
                            <a class='btn btn-block btn-{{$section->status == 1 ? "danger" : "success"}}'
                                href="{{$section->status == 1 ? route('section.disabled', $section->id) : route('section.active', $section->id)}}">
                                <i
                                    class="{{$section->status == 1 ? "fa fa-fw fa-close" : "fa fa-check fa-fw fa-lg"}}"></i>
                                {{$section->status == 1 ? "Disable" : "Active"}}</a>
                        </div>

                        <div class="button-page-header" style="margin-top:5px">
                            <a class="btn btn-block btn-info" href="{{route('sections.edit', $section->id)}}">
                    ...
                    <div class="box-body">
                        ...
                        @endif
                        <form id="myForm" action="" method="POST" class="brandForm" enctype="multipart/form-data"
                                ...
                                <h4 style="margin:0">asdasdasd </h4>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <h4 style="margin:0">
                                                    <span
                                                        class='badge label-{{$section->status == 1 ? "success" : "danger"}}'>{{$section->status == 1 ? "active" : "disabled"}}</span>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <h4 style="margin:0">
                                                    @if ($section->userCreatedSection->role == 2)
                                                    Super admin
                                                    @elseif ($section->role == 1)
                                                    admin
                                                    @else
                                                    user
                                                    @endif
                                                </h4>
                                                <h4 style="margin:0">{{$section->userCreatedSection->email}} </h4>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <h4 style="margin:0">
                                                    @if ($section->userUpdatedSection->role == 2)
                                                    Super admin
                                                    @elseif ($section->role == 1)
                                                    admin
                                                    @else
                                                ...
                                                <h4 style="margin:0">{{$section->userUpdatedSection->email}} </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <h4 style="margin:0">
                                                    <p>{{$section->created_at->format('Y-m-d')}} </p>
                                                    <p>{{$section->created_at->format('H:i:s a')}}</p>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <h4 style="margin:0">
                                                    <p>{{$section->updated_at->format('Y-m-d')}}</p>
                                                    <p>{{$section->updated_at->format('H:i:s a')}}</p>
                                                </h4>
                                            </div>
                                        </div>
                                        <!-- End Row  -->
