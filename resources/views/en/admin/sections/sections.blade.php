        ...
        <div class="content-wrapper " style="min-height: 698px;">
            ...
            <section class="content-header">
                <h1 class="dashboard-page-title">
                     <i class="fa fa-tags"></i> Sections</h1>
            </section>
            <!-- Content Header (Page header) -->
                                        ...
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="datatable"
                                                        ...
                                                        style="width: 11px;">#id</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Arabic Name: activate to sort column ascending"
                                                        style="width: 58px;"><b>Name</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Arabic Name: activate to sort column ascending"
                                                        style="width: 58px;"><b>Desc</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Status: activate to sort column ascending"
                                                        style="width: 44px;"><b>Status</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Date: activate to sort column ascending"
                                                        style="width: 45px;"><b>Created at</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Date: activate to sort column ascending"
                                                        style="width: 45px;"><b>Updated at</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Date: activate to sort column ascending"
                                                        style="width: 45px;"><b>Created By</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Date: activate to sort column ascending"
                                                        style="width: 45px;"><b>Updated By</b></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="even">
                                                    ...
                                                    <td>{{$section->name}}</td>
                                                    <td>{!! html_entity_decode(e($section->desc)) !!}</td>
                                                    <td>
                                                        <span class='badge label-{{$section->status == 1 ? "success" : "danger"}}'>{{$section->status == 1 ? "active" : "disabled"}}</span>
                                                    </td>
                                                    <td>
                                                        <div><b>Created at:</b>{{$section->created_at->format('Y-m-d')}} </div>
                                                    </td>
                                                    <td>
                                                      <div><b>Updated at:</b>{{$section->updated_at->format('Y-m-d')}}</div>
                                                  </td>
                                                    <td>{{$section->userCreatedSection->name}}</td>
                                                    <td>{{$section->userUpdatedSection->name}}</td>
                                                    <td>
                                                            ...
                                                            <ul role="menu"
                                                                ...
                                                                <li>
                                                                    <a title="Disable Record"
                                                                        href="http://carsrental.great-site.net/en/admin/cars/activation/32">
