                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        @elseif ($notification->type == 'App\Notifications\admin\RentNotify')
                                        <li>
                                            <a href="{{route('showRentFromNotification', $notification->id)}}">
                                                <div class="pull-left">
                                                    <img src="../../../uploads/cars/default.png" class="img-circle"
                                                        alt="User Image">
                                                </div>
                                        ...
                                        @elseif($notification->type == 'App\Notifications\admin\CommentNotify')
                                            <li>
                                                <!-- start message -->
                                                <a href="{{route('showCommentsFromNotification', $notification->id)}}">
                                                    {{-- <a href="http://carsrental.great-site.net/en/admin/comments/show/17"> --}}
                                                    <div class="pull-left">
                                                        <img src="../../../uploads/cars/default.png" class="img-circle"
                                                            alt="User Image">
                                                    ...
                                                    <p style="color:#1a91d7">New commet has been added
                                                        by {{$notification->data['user_createName']}} !</p>
                                                    <div class="starts">
                                                        <i class="fa fa-star text-orange"></i>
                                                        <i class="fa fa-star text-orange"></i>
                                                        <i class="fa fa-star text-orange"></i>
        ...
        <div class="content-wrapper " style="min-height: 788px;">
            ...
            <section class="content-header">
                <h1 class="dashboard-page-title">
                    <i class="fa fa-check-circle"></i> Rents
                </h1>
            </section>
            <!-- Content Header (Page header) -->
