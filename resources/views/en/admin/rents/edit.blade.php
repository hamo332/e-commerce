                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="button-page-header" style="margin-top:5px">
                            <a class="btn btn-block btn-warning" href="{{route('rents.index')}}">
                    ...
                    <div class="box-body">
                        ...
                        <form id="myForm" action="{{route('rents.update', $rent->id)}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_en" id="name_en" class="form-control " value="{{$rent->name}}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="proccesses" id="proccesses"
                                            ...
                                            <option value="">..........</option>
                                            <option value="accepted" {{$rent->processes == 'accepted' ? 'selected' : ''}}>accepted</option>
                                            <option value="disabled" {{$rent->processes == 'disabled' ? 'selected' : ''}}>disabled</option>
                                            <option value="processed" {{$rent->processes == 'processed' ? 'selected' : ''}}>processed</option>
                                            <option value="Cancelled" {{$rent->processes == 'Cancelled' ? 'selected' : ''}}>Cancelled</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="creator" id="creator"
                                            ...
                                            tabindex="-1" aria-hidden="true">
                                            <option value="">..........</option>
                                            <option value="admin" {{$rent->creator == 'admin' ? 'selected' : ''}}>Admin</option>
                                            <option value="user" {{$rent->creator == 'user' ? 'selected' : ''}}>User</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- user email --}}
                            <div class="row">
                                <div class="col-md-12 user-email" style={{$rent->creator == 'user'? "display:block;" : "display:none;"}}>
                                    <div class="form-group">
                                        ...
                                        <select name="created_by" id="created_by"
                                            ...
                                            <option value="{{$user->id}}" {{$rent->created_by == $user->id ? 'selected' : ''}}>{{$user->email}} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="section_id" id="section_id"
                                            ...
                                            @foreach ($sections as $section)
                                                <option value="{{$section->id}}" {{$rent->section_id == $section->id ? 'selected' : ""}}>{{$section->name}} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="brand_id" id="brand_id"
                                            ...
                                            @foreach ($brands as $brand)
                                                <option value="{{$brand->id}}" {{$rent->brand_id == $brand->id ? 'selected' : ""}}>{{$brand->name}} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="purpose" id="purpose"
                                            ...
                                            tabindex="-1" aria-hidden="true">
                                            <option value="">..........</option>
                                            <option value="sale" {{$rent->purpose == 'sale' ? 'selected' : ''}}>Sale</option>
                                            <option value="buy" {{$rent->purpose == 'buy' ? 'selected' : ''}}>Buy</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$rent->price}}" name="price" id="price" class="form-control " value="">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="timeframe" id="timeframe"
                                            ...
                                            tabindex="-1" aria-hidden="true">
                                            <option value="">..........</option>
                                            <option value="hour" {{$rent->timeframe == 'hour' ? 'selected' : ''}}>hour</option>
                                            <option value="day" {{$rent->timeframe == 'day' ? 'selected' : ''}}>day</option>
                                            <option value="week" {{$rent->timeframe == 'week' ? 'selected' : ''}}>week</option>
                                            <option value="month" {{$rent->timeframe == 'month' ? 'selected' : ''}}>month</option>
                                            <option value="year" {{$rent->timeframe == 'year' ? 'selected' : ''}}>year</option>
                                        </select>
                                        @error('timeframe')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$rent->discount}}" name="discount" id="discount" class="form-control " value="">
                                    </div>
                                </div>
                            </div>
                            <!-- Start Row  -->
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc_en" id="desc_en" class="form-control"
                                            style="display: none;">{{$rent->disc}}</textarea>
                                    </div>
                                </div>
                            </div>
