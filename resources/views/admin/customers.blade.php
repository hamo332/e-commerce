                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        ...
                                                        style="width: 54px;"><b>Image</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Name: activate to sort column ascending"
                                                        style="width: 103px;"><b>Name</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Email Address: activate to sort column ascending"
                                                        style="width: 207px;"><b>Email</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Phone: activate to sort column ascending"
                                                        style="width: 102px;"><b>Phone</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Phone: activate to sort column ascending"
                                                        style="width: 102px;"><b>Address</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Phone: activate to sort column ascending"
                                                        style="width: 102px;"><b>PostCode</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Status: activate to sort column ascending"
                                                        style="width: 53px;"><b>Status</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Date: activate to sort column ascending"
                                                        style="width: 88px;"><b>Created at</b></th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Date: activate to sort column ascending"
                                                        style="width: 88px;"><b>Updated at</b></th>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <img style="width:40px;height:35px"
                                                            src="../customer_files/default(1).png" alt="">
                                                    </td>
                                                    <td>{{$user->name}}</td>
                                                    <td>{{$user->email}}</td>
                                                    <td>{{$user->phone}}</td>
                                                    ...
                                                    <td>
                                                        <span class={{$user->role == 0 ? "badge label-success" : "badge label-danger"}}>{{$user->role == 0 ? 'Active' : 'Deleted'}}</span>
                                                    </td>
                                                            ...
                                                            <ul role="menu"
                                                                ...
                                                                <li>
                                                                    <form
                                                                        ...
                                                                        <input type="hidden" name="_token"
                                                                            value="kXqIZKzWRCB4rLHPhnI7rn3K1Ja0WwtYbuLao7tv">
